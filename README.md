...
```jsonc
"dependencies": {
  "@railgun-community/ledger-client": "github:Railgun-Community/ledger-client#v0.2.2"
}
```
...
```bash
yarn add https://github.com/Railgun-Community/ledger-client/releases/download/v0.2.2/railgun-community-ledger-client-0.2.2.tgz
```
